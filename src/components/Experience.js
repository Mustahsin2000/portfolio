...
import css from "../assests/CSS3_logo_and_wordmark.svg.png";
...
const Experience = () => {
    ...
    return (
        <div
            name="experience"
            className="bg-gradient-to-b  w-full h-screen mt-11 mb-11"
        >
            <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full ">
                <div>
                    <p className="text-4xl font-bold border-b-4 border-gray-500   text-teal-600 p-2 inline">
                        Experience
                    </p>
